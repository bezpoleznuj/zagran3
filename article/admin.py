...
class ArticleAdmin(admin.ModelAdmin):
    fieldsets = (('Адреса', {'fields': ('article_country', 'article_address')}),(None, {'fields': ('article_short_title','article_text','article_date','article_status','article_price','article_spase','article_rooms','article_floor','article_area','article_walls','article_foto')}),)
